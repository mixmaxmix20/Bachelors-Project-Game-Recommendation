...
function Button({ onClickPar, isStandalone, children, isLogout }: ButtonProps) {
    ...
    const baseClasses = "flex items-center border-none text-white bg-[#1f2326] py-3 px-6 m-2 text-2xl rounded-lg cursor-pointer w-[88%] overflow-hidden transition-all duration-300 hover:scale-105"
