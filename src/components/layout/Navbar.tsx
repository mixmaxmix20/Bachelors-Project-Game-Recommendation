...
function Navbar() {
  ...
  return (
      <>
        ...
        {/*Desktop*/}
        <aside className="hidden md:flex fixed top-0 left-0 h-screen w-15 bg-[#1f2326] text-white p-2.5 box-border flex-col items-center shadow-md font-sans transition-[width] duration-300 ease-in-out overflow-hidden z-10 group hover:w-64 hover:text-amber-300">
